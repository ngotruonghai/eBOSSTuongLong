class ChiTietPhieuMuaHangModel {
  ...
  ChiTietPhieuMuaHangModel(
      {this.succeeded, this.code, this.message, this.errors, this.data, required String maHang});

  ChiTietPhieuMuaHangModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    ngayDuKienTraLoi = json['NgayDuKienTraLoi'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['NgayDuKienTraLoi'] = this.ngayDuKienTraLoi;
    return data;
  }
}
